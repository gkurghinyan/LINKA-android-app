...
public class LinkaTouchableRelativeLayout extends RelativeLayout {
    public LinkaTouchableRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
        getAttrs(attrs);
    }

    public LinkaTouchableRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        getAttrs(attrs);
    }
