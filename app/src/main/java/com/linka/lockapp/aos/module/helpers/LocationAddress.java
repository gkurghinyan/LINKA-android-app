            ...
            public void run() {
                ...
                try {
                    ...
                    if (addressList != null && addressList.size() > 0) {
                        ...
                        result = sb.toString();
                        LinkaAddress.saveAddressForLatLng(latitude + "", longitude + "", result);
                        EventBus.getDefault().post(LinkaActivity.LINKA_ACTIVITY_ON_CHANGE);
                        LogHelper.e(TAG, "Found Address: " + latitude + " " + longitude + " " + result);
                    }
                } catch (IOException e) {
                    LogHelper.e(TAG, "Unable connect to Geocoder");
                } finally {
